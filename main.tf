provider "aws" {
  region = "us-east-1"
  access_key = "AKIAX4T4X7U4C227XD44"
  secret_key = "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"
}
...
# 7. create a network interface with an ip within the subnet
